...
totfile=1000000; #maximum number of files to process
subpref1="HTML";
subpref2="TEXT";
...
{
  write2Html('<!DOCTYPE html>
<html lang="en">
<head>
             <title>iRDP | iATMS</title>
             <meta charset="utf-8">
             ...
             <li><a class="active" href="/iATMs.html">iATMs</a></li>
  ...
  write2Html(header,filepath,TRUE);
...
#########################################################################################################################################################
	...
	#print(grep("ATOM",readLines(pdbfile)));
	if(length(grep("^ATOM",readLines(pdbfile)))<10)
	{
      ...
      <div class="wrapper">
        ...
        <div class="grid_5">
          <div class="indent-top2">
            <br><p class="prev-indent-bot">&copy; 2014 All rights reserved by NCL, Pune <a target="_blank" href="http://www.ncl-india.org/">ncl-india.org</a></p>
            Phone: +91 20 2590 2711 Email: <a href="#">irdpncl@gmail.com</a> </div>
           </div>
             ...
             </html>',htmldir$sumpath,append=TRUE);
